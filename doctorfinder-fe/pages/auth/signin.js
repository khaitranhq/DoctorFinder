...
import { login } from "../../src/utils/actions";
...
class SignIn extends React.Component {
  ...
  validate = () => {
    ...
    if (
      !re.test(String(this.state.email).toLowerCase().trimLeft().trimRight())
    ) {
      emailError = true;
    }
          ...
          >
            ...
            <form noValidate onSubmit={this.handleSubmit}>
              <TextField
                ...
                helperText={this.state.emailError ? "email-Error" : " "}
              />
              <TextField
                id="password"
                name="password"
                ...
                helperText={this.state.passwordError ? "password-Error" : " "}
              />
            ...
            >
              ...
              &nbsp;
              <Link href="./signup">
                <a data-cy="link-to-signup" className={classes.signup}>
                  Đăng kí tại đây
                </a>
              </Link>
            </Grid>
